...
class PHPMailer
{
    ...
    public function smtpConnect($options = null)
    {
        ...
        foreach ($hosts as $hostentry) {
            ...
            // $hostinfo[1]: optional ssl or tls articleprefix
            // $hostinfo[2]: the hostname
            // $hostinfo[3]: optional port number
            // The host string articleprefix can temporarily override the current setting for SMTPSecure
            ...
            if ('ssl' === $hostinfo[1] || ('' === $hostinfo[1] && static::ENCRYPTION_SMTPS === $this->SMTPSecure)) {
                ...
                $tls = true;
                // tls doesn't use a articleprefix
    ...
    public function createHeader()
    {
        ...
        if ('' !== $this->ConfirmReadingTo) {
            $result .= $this->headerLine('Disposition-NotificationType-To', '<' . $this->ConfirmReadingTo . '>');
        }
