...
class Paginator
{
    ...
    public function toHtmlFrontend($prev='<', $next='>')
    {
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li class="pre"><a href="' . htmlspecialchars($this->getPrevUrl()) . '"><strong>'. $prev .'</strong></a></li>';
        }
        ...
        if ($this->getNextUrl()) {
            $html .= '<li class="next"><a href="' . htmlspecialchars($this->getNextUrl()) . '"><strong>'. $next .'</strong></a></li>';
        }
        $html .= '</ul>';
        $html .= '</div>';
        $html .= '</div>';
